package fr.onitsag.faritech.programs.auction;
...
import fr.onitsag.faritech.api.app.Layout.Background;
...
import fr.onitsag.faritech.programs.auction.object.AuctionItem;
import fr.onitsag.faritech.programs.auction.task.TaskAddAuction;
import fr.onitsag.faritech.programs.auction.task.TaskBuyItem;
import fr.onitsag.faritech.programs.auction.task.TaskGetAuctions;
import fr.onitsag.faritech.util.TimeUtil;
...
public class ApplicationMineBay extends Application
{
	...
	private static final ResourceLocation MINEBAY_ASSESTS = new ResourceLocation("faritech:textures/gui/minebay.png");
