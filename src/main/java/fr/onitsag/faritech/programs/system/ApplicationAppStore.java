...
import fr.onitsag.faritech.api.app.component.Spinner;
import fr.onitsag.faritech.api.utils.OnlineRequest;
...
import fr.onitsag.faritech.programs.system.component.AppGrid;
import fr.onitsag.faritech.programs.system.layout.LayoutAppPage;
import fr.onitsag.faritech.programs.system.layout.LayoutSearchApps;
import fr.onitsag.faritech.programs.system.object.AppEntry;
import fr.onitsag.faritech.programs.system.object.RemoteEntry;
...
public class ApplicationAppStore extends SystemApplication
{
	...
	public static class StoreTrayItem extends TrayItem
	{
		...
		{
			AppInfo info = ApplicationManager.getApplication("faritech:app_store");
			if(info != null)
			{
