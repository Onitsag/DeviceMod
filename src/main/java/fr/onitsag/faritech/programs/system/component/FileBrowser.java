package fr.onitsag.faritech.programs.system.component;
...
import fr.onitsag.faritech.api.app.listener.ItemClickListener;
...
import fr.onitsag.faritech.core.Window;
import fr.onitsag.faritech.core.Wrappable;
import fr.onitsag.faritech.core.io.FileSystem;
import fr.onitsag.faritech.core.io.task.TaskGetFiles;
import fr.onitsag.faritech.core.io.task.TaskGetStructure;
import fr.onitsag.faritech.core.io.task.TaskSetupFileBrowser;
...
{
    private static final ResourceLocation ASSETS = new ResourceLocation("faritech:textures/gui/file_browser.png");
