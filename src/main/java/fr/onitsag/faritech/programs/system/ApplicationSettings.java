...
import fr.onitsag.faritech.api.app.component.CheckBox;
import fr.onitsag.faritech.api.app.component.ComboBox;
import fr.onitsag.faritech.api.app.renderer.ItemRenderer;
import fr.onitsag.faritech.api.utils.RenderUtil;
import fr.onitsag.faritech.core.Laptop;
import fr.onitsag.faritech.core.Settings;
import fr.onitsag.faritech.object.AppInfo;
import fr.onitsag.faritech.object.TrayItem;
import fr.onitsag.faritech.programs.system.component.Palette;
...
public class ApplicationSettings extends SystemApplication
{
	...
	public static class SettingsTrayItem extends TrayItem
	{
		...
		{
			AppInfo info = ApplicationManager.getApplication("faritech:settings");
			if(info != null)
			{
