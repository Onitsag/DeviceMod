...
import fr.onitsag.faritech.programs.system.task.TaskDeposit;
import fr.onitsag.faritech.programs.system.task.TaskWithdraw;
...
public class ApplicationBank extends SystemApplication
{
	...
	private static final ResourceLocation BANK_ASSETS = new ResourceLocation("faritech:textures/gui/bank.png");
