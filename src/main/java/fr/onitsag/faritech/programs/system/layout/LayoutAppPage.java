...
import fr.onitsag.faritech.api.app.component.Text;
import fr.onitsag.faritech.core.Laptop;
import fr.onitsag.faritech.object.AppInfo;
import fr.onitsag.faritech.programs.gitweb.component.GitWebFrame;
import fr.onitsag.faritech.programs.system.ApplicationAppStore;
import fr.onitsag.faritech.programs.system.component.SlideShow;
import fr.onitsag.faritech.programs.system.object.AppEntry;
import fr.onitsag.faritech.programs.system.object.LocalEntry;
...
public class LayoutAppPage extends Layout
{
    ...
    private void openWebLink(String url)
    {
        ...
        catch (Throwable throwable1)
        {
            ...
            FariTechMod.getLogger().error("Couldn't open link: {}", (Object)(throwable == null ? "<UNKNOWN>" : throwable.getMessage()));
        }
    }
}
