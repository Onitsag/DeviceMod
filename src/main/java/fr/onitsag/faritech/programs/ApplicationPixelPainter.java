package fr.onitsag.faritech.programs;
...
import fr.onitsag.faritech.api.app.listener.SlideListener;
...
import fr.onitsag.faritech.object.ColorGrid;
import fr.onitsag.faritech.object.Picture;
import fr.onitsag.faritech.object.Picture.Size;
...
{
	private static final ResourceLocation PIXEL_PAINTER_ICONS = new ResourceLocation("faritech:textures/gui/pixel_painter.png");
