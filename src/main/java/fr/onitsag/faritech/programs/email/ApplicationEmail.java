package fr.onitsag.faritech.programs.email;

import fr.onitsag.faritech.api.ApplicationManager;
import fr.onitsag.faritech.api.app.*;
...
import fr.onitsag.faritech.api.app.component.TextArea;
import fr.onitsag.faritech.api.app.component.TextField;
import fr.onitsag.faritech.api.app.listener.InitListener;
...
import fr.onitsag.faritech.programs.email.object.Contact;
import fr.onitsag.faritech.programs.email.object.Email;
...
{
	private static final ResourceLocation ENDER_MAIL_ICONS = new ResourceLocation("faritech:textures/gui/ender_mail.png");
	private static final ResourceLocation ENDER_MAIL_BACKGROUND = new ResourceLocation("faritech:textures/gui/ender_mail_background.png");
