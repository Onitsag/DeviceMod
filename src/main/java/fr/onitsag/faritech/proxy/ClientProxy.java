...
import fr.onitsag.faritech.DeviceConfig;
import fr.onitsag.faritech.FariTechMod;
import fr.onitsag.faritech.Reference;
...
import fr.onitsag.faritech.core.client.ClientNotification;
...
import fr.onitsag.faritech.tileentity.render.*;
...
public class ClientProxy extends CommonProxy implements IResourceManagerReloadListener
{
    ...
    public void init()
    {
        ...
        if(FariTechMod.DEVELOPER_MODE)
        {
            Laptop.addWallpaper(new ResourceLocation("faritech:textures/gui/developer_wallpaper.png"));
        }
        else
        {
            Laptop.addWallpaper(new ResourceLocation("faritech:textures/gui/laptop_wallpaper_1.png"));
            Laptop.addWallpaper(new ResourceLocation("faritech:textures/gui/laptop_wallpaper_2.png"));
            Laptop.addWallpaper(new ResourceLocation("faritech:textures/gui/laptop_wallpaper_3.png"));
            Laptop.addWallpaper(new ResourceLocation("faritech:textures/gui/laptop_wallpaper_4.png"));
            Laptop.addWallpaper(new ResourceLocation("faritech:textures/gui/laptop_wallpaper_5.png"));
            Laptop.addWallpaper(new ResourceLocation("faritech:textures/gui/laptop_wallpaper_6.png"));
            Laptop.addWallpaper(new ResourceLocation("faritech:textures/gui/laptop_wallpaper_7.png"));
        }
    }
        ...
        for(AppInfo info : ApplicationManager.getAllApplications())
        {
            ...
            try
            {
                ...
                if(input != null)
                {
                    ...
                    {
                        FariTechMod.getLogger().error("Incorrect icon size for " + identifier.toString() + " (Must be 14 by 14 pixels)");
                        continue;
                    }
                ...
                {
                    FariTechMod.getLogger().error("Icon for application '" + identifier.toString() +  "' could not be found at '" + path + "'");
                }
            }
            catch(Exception e)
            {
                FariTechMod.getLogger().error("Unable to load icon for " + identifier.toString());
            }
        }
    ...
    public boolean registerPrint(ResourceLocation identifier, Class<? extends IPrint> classPrint)
    {
        try
        {
            ...
            {
                FariTechMod.getLogger().error("The print renderer '" + classRenderer.getName() + "' is missing an empty constructor and could not be registered!");
                return false;
            }
            return true;
        }
        ...
        {
            FariTechMod.getLogger().error("The print '" + classPrint.getName() + "' is missing an empty constructor and could not be registered!");
        }
        return false;
    }
