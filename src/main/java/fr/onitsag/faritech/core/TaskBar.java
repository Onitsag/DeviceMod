...
import fr.onitsag.faritech.core.network.TrayItemWifi;
...
{
	public static final ResourceLocation APP_BAR_GUI = new ResourceLocation("faritech:textures/gui/application_bar.png");

	private static final int APPS_DISPLAYED = FariTechMod.DEVELOPER_MODE ? 18 : 10;
	...
	public void setupApplications(List<Application> applications)
	{
		final Predicate<Application> VALID_APPS = app ->
		{
			...
			if(FariTechMod.proxy.hasAllowedApplications())
			{
				...
				{
					return !FariTechMod.DEVELOPER_MODE || Settings.isShowAllApps();
				}
				return false;
			}
			else if(FariTechMod.DEVELOPER_MODE)
			{
