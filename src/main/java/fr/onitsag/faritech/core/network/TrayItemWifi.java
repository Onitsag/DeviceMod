...
import fr.onitsag.faritech.core.Device;
...
import fr.onitsag.faritech.tileentity.TileEntityDevice;
...
public class TrayItemWifi extends TrayItem
{
    ...
    private static Layout createWifiMenu(TrayItem item)
    {
        ...
        fr.onitsag.faritech.api.app.component.Button buttonConnect = new fr.onitsag.faritech.api.app.component.Button(79, 79, Icons.CHECK);
