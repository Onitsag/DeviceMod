package fr.onitsag.faritech.core.io;
...
import fr.onitsag.faritech.core.io.drive.ExternalDrive;
import fr.onitsag.faritech.core.io.drive.InternalDrive;
import fr.onitsag.faritech.core.io.task.TaskGetFiles;
import fr.onitsag.faritech.core.io.task.TaskGetMainDrive;
import fr.onitsag.faritech.core.io.task.TaskSendAction;
import fr.onitsag.faritech.init.DeviceItems;
...
public class FileSystem
{
	...
	public static void getApplicationFolder(Application app, Callback<Folder> callback)
	{
		...
		{
			if(!FariTechMod.proxy.getAllowedApplications().contains(app.getInfo()))
			{
