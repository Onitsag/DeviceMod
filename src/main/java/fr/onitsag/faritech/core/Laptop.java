package fr.onitsag.faritech.core;
...
import fr.onitsag.faritech.api.app.System;
import fr.onitsag.faritech.api.app.component.Image;
import fr.onitsag.faritech.api.io.Drive;
import fr.onitsag.faritech.api.io.File;
import fr.onitsag.faritech.api.task.Callback;
...
import fr.onitsag.faritech.core.client.LaptopFontRenderer;
...
import fr.onitsag.faritech.programs.system.task.TaskUpdateApplicationData;
import fr.onitsag.faritech.programs.system.task.TaskUpdateSystemData;
import fr.onitsag.faritech.tileentity.TileEntityLaptop;
import fr.onitsag.faritech.util.GuiHelper;
...
public class Laptop extends GuiScreen implements System
{
	...
	{
		if(FariTechMod.proxy.hasAllowedApplications())
		{
			return FariTechMod.proxy.getAllowedApplications().contains(info);
		}
		return true;
	}
	 ...
	 */
	public fr.onitsag.faritech.core.Window[] getOpenWindows() {
		return this.windows;
	}
}
