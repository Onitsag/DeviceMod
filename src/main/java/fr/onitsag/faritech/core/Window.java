...
import fr.onitsag.faritech.gui.GuiButtonClose;
...
{
	public static final ResourceLocation WINDOW_GUI = new ResourceLocation("faritech:textures/gui/application.png");
