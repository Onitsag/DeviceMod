...
import fr.onitsag.faritech.network.task.MessageNotification;
 ...
 * {@link fr.onitsag.faritech.api.task.Task} from the client to the server. It is not possible to
 * do this from the client side alone.
 *
 * If a notification is needed to be produced on the client side only, see
 * {@link fr.onitsag.faritech.core.client.ClientNotification}
 */
