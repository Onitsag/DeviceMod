...
import fr.onitsag.faritech.item.SubItems;
...
public class RegistrationHandler
{
    ...
    public static class Blocks
    {
        ...
        {
            FariTechMod.getLogger().info("Registering blocks");
    ...
    public static class Items
    {
        ...
        {
            FariTechMod.getLogger().info("Registering items");
    ...
    public static class Recipes
    {
        ...
        {
            FariTechMod.getLogger().info("Registering recipes");
    ...
    public static class Models
    {
        ...
        {
            FariTechMod.getLogger().info("Registering models");
